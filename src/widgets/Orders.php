...
namespace cliveportman\appstackretail\widgets;

use cliveportman\appstackretail\AppstackRetail;
use cliveportman\appstackretail\assetbundles\orderswidget\OrdersWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Appstack Retail Widget
 *
...
class Orders extends Widget
{
    ...
    {
        return Craft::t('appstack-retail', 'Orders');
    }
    ...
    {
        return Craft::getAlias("@cliveportman/appstackretail/assetbundles/orderswidget/dist/img/Orders-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'appstack-retail/_components/widgets/Orders_settings',
            [
                'widget' => $this
            ]
        );
    ...
    public function getBodyHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'appstack-retail/_components/widgets/Orders_body',
            [

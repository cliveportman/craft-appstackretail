...
namespace cliveportman\appstackretail\assetbundles\AppstackRetail;
...
/**
 * AppstackRetailAsset AssetBundle
 *
 ...
 * @since     1.0.0
 */
class AppstackRetailAsset extends AssetBundle
{
    // Public Methods
    // =========================================================================
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@cliveportman/appstackretail/assetbundles/appstackretail/dist";
        ...
        $this->js = [
            'js/AppstackRetail.js',
        ];

        $this->css = [
            'css/AppstackRetail.css',
        ];
